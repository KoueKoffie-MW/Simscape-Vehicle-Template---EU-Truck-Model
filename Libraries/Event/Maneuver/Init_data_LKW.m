...
Init.Axle1.nWheel.Value = [1.4857 1.4857 0.6731];
Init.Axle2 = struct;
Init.Axle2.nWheel = struct;
Init.Axle2.nWheel.Units = 'rad/s';
Init.Axle2.nWheel.Comments = 'Values are [left right]';
Init.Axle2.nWheel.Value = [1.4857 1.4857 0.6731];
Init.Axle3 = struct;
Init.Axle3.nWheel = struct;
Init.Axle3.nWheel.Units = 'rad/s';
Init.Axle3.nWheel.Comments = 'Values are [left right]';
Init.Axle3.nWheel.Value = [1.4857 1.4857 0.6731];
