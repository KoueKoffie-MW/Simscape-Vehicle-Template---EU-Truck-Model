...
cabin.cabinOriginStart = [0.4969;  0;  1.5704];

cabin.cabinMass = 1242.63; % Mass of the cabin in kg
cabin.cabinJxx  = 1490.0;  % Inertia in the cabin fixed frame in kgm^2        
cabin.cabinJyy  = 1273.0;  % Inertia in the cabin fixed frame in kgm^2        
cabin.cabinJzz  = 1476.4;  % Inertia in the cabin fixed frame in kgm^2  
